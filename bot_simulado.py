...
data_compartida = {
    ...
    "top_rutas_html": "Cargando rutas...",
    "transacciones_html": "Esperando oportunidades (>= 0.3%)...",
...
def bucle_bot_segundo(socketio_instance):
    ...
    while True:
        if not BOT_ENCENDIDO:
            data_compartida["top_rutas_html"] = "<div style='color:gray;text-align:center;'>Bot en pausa.</div>"
        ...
        try:
            ...
            # Emitir los datos por WebSocket solo a los móviles conectados
            socketio_instance.emit('update_data', obtener_payload_datos())
...
def obtener_payload_datos():
    ...
    comision_estimada = CAPITAL_SIMULADO * 0.0030 # 0.10% por cada salto (3 saltos = 0.30%)
...
def toggle_bot():
    ...
    return "", 204 # Respuesta rápida HTTP sin recargar interfaz
